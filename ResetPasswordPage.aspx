<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResetPasswordPage.aspx.cs" Inherits="ResetPasswordPage" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="resetPasswordLabel" runat="server" Text="Reset Password"></asp:Label><br />
            <asp:TextBox ID="emailTb" runat="server" placeholder="Enter Valid Email Address"></asp:TextBox><br />
            <asp:TextBox ID="resetPasswordTb" runat="server" placeholder="Enter New Password"></asp:TextBox><br /><br />
